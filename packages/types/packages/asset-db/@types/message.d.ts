...
export interface message extends EditorMessageMap {
  ...
  'create-asset': {
    params:
      ...
      | [string, string | Buffer | null, AssetOperationOption]
    result: AssetInfo | null
  }
  'import-asset': {
    params: [string, string] | [string, string, AssetOperationOption]
    result: AssetInfo | null
  }
  'copy-asset': {
    params: [string, string] | [string, string, AssetOperationOption]
