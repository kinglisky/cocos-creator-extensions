...
declare module 'cc/editor/exotic-animation' {
  ...
  export class ExoticAnimation {
    createEvaluator(
      binder: ___private._cocos_core_animation_tracks_track__Binder
    ): ___private._cocos_core_animation_exotic_animation_exotic_animation__ExoticTrsAnimationEvaluator
    addNodeAnimation(
      path: string
    ): ___private._cocos_core_animation_exotic_animation_exotic_animation__ExoticNodeAnimation
...
declare module 'cc/editor/new-gen-anim' {
  ...
  export class AnimationGraph extends Asset implements animation.AnimationGraphRunTime {
    ...
    addTrigger(
      name: string,
      value?: boolean,
      resetMode?: __private._cocos_core_animation_marionette_animation_graph__TriggerResetMode
    ): void
  ...
  export class StateMachine extends ___private._cocos_core_data_editor_extendable__EditorExtendable {
    ...
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      context: __private._cocos_core_animation_marionette_motion__MotionEvalContext
    ): __private._cocos_core_animation_marionette_motion__MotionEval | null
    /**
     * The entry state.
     */
    ...
    getTransitionsBetween(
      from: State,
      to: State
    ): Iterable<__private._cocos_core_animation_marionette_animation_graph__Transition>
    /**
    ...
    removeTransition(
      removal: __private._cocos_core_animation_marionette_animation_graph__Transition
    ): void
  ...
  export type Transition = Omit<
    __private._cocos_core_animation_marionette_animation_graph__Transition,
    'from' | 'to'
  > & {
  ...
  export type AnimationTransition = Omit<
    __private._cocos_core_animation_marionette_animation_graph__AnimationTransition,
    'from' | 'to'
  > & {
  ...
  export class Layer
    implements __private._cocos_core_animation_marionette_ownership__OwnedBy<AnimationGraph>
  {
  ...
  export class State
    ...
    implements __private._cocos_core_animation_marionette_ownership__OwnedBy<Layer | StateMachine>
  {
  ...
  export type VariableDescription =
    | __private._cocos_core_animation_marionette_animation_graph__BasicVariableDescription<animation.VariableType.FLOAT>
    | __private._cocos_core_animation_marionette_animation_graph__BasicVariableDescription<animation.VariableType.INTEGER>
    | __private._cocos_core_animation_marionette_animation_graph__BasicVariableDescription<animation.VariableType.BOOLEAN>
    | __private._cocos_core_animation_marionette_animation_graph__TriggerVariable
  export class BinaryCondition implements Condition {
    ...
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      context: __private._cocos_core_animation_marionette_parametric__BindContext
    ): __private._cocos_core_animation_marionette_condition__BinaryConditionEval
  }
  ...
  export class UnaryCondition implements Condition {
    ...
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      context: __private._cocos_core_animation_marionette_condition__ConditionEvalContext
    ): __private._cocos_core_animation_marionette_condition__UnaryConditionEval
  }
  ...
  export class TriggerCondition implements Condition {
    ...
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      context: __private._cocos_core_animation_marionette_parametric__BindContext
    ): __private._cocos_core_animation_marionette_condition__ConditionEval
  }
  ...
  export class ClipMotion
    extends ___private._cocos_core_data_editor_extendable__EditorExtendable
    implements __private._cocos_core_animation_marionette_motion__Motion
  {
    clip: AnimationClip | null;
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      context: __private._cocos_core_animation_marionette_motion__MotionEvalContext
    ): __private._cocos_core_animation_marionette_clip_motion__ClipMotionEval | null
    clone(): ClipMotion
  }
  export interface AnimationBlend
    extends __private._cocos_core_animation_marionette_motion__Motion,
      ___private._cocos_core_data_editor_extendable__EditorExtendable {
    [__private._cocos_core_animation_marionette_create_eval__createEval](
      _context: __private._cocos_core_animation_marionette_motion__MotionEvalContext
    ): __private._cocos_core_animation_marionette_motion__MotionEval | null
  }
  ...
  export class AnimationBlendDirect extends AnimationBlend {
    ...
    set items(
      value: __private._cocos_core_animation_marionette_animation_blend_direct__AnimationBlendDirectItem[]
    )
  ...
  export namespace AnimationBlendDirect {
    export type Item =
      __private._cocos_core_animation_marionette_animation_blend_direct__AnimationBlendDirectItem
  }
  export class AnimationBlend1D extends AnimationBlend {
    ...
    set items(
      value: Iterable<__private._cocos_core_animation_marionette_animation_blend_1d__AnimationBlend1DItem>
    )
  ...
  export namespace AnimationBlend1D {
    export type Item =
      __private._cocos_core_animation_marionette_animation_blend_1d__AnimationBlend1DItem
  }
  export class AnimationBlend2D extends AnimationBlend {
    ...
    set items(
      items: Iterable<__private._cocos_core_animation_marionette_animation_blend_2d__AnimationBlend2DItem>
    )
  ...
  export namespace AnimationBlend2D {
    export type Algorithm =
      typeof __private._cocos_core_animation_marionette_animation_blend_2d__Algorithm
    export type Item =
      __private._cocos_core_animation_marionette_animation_blend_2d__AnimationBlend2DItem
  }
  export class BindableNumber
    implements __private._cocos_core_animation_marionette_parametric__Bindable<number>
  {
    variable: string
    value: number
  ...
  export class BindableBoolean
    implements __private._cocos_core_animation_marionette_parametric__Bindable<boolean>
  {
    variable: string
    value: boolean
  ...
  export namespace AnimationMask {
    export type JointMaskInfo =
      __private._cocos_core_animation_marionette_animation_mask__JointMaskInfo_
  }
  ...
  export namespace __private {
     ...
     */
    export enum _cocos_core_animation_marionette_animation_graph__TriggerResetMode {
      /**
       * @zh 在该变量被动画过渡消耗后自动重置。
       */
      AFTER_CONSUMED = 0,
    ...
    export class _cocos_core_animation_marionette_variable__VarInstance {
      ...
      resetMode: _cocos_core_animation_marionette_animation_graph__TriggerResetMode
    ...
    export interface _cocos_core_animation_marionette_motion__MotionEvalContext
      extends _cocos_core_animation_marionette_parametric__BindContext {
      node: Node
    ...
    export class _cocos_core_animation_marionette_animation_graph__Transition
      extends ___private._cocos_core_data_editor_extendable__EditorExtendable
      implements
        _cocos_core_animation_marionette_ownership__OwnedBy<StateMachine>,
        _cocos_core_animation_marionette_animation_graph__Transition
    {
    ...
    export type _cocos_core_animation_marionette_state__StateMachineComponentConstructor<
    ...
    export class _cocos_core_animation_marionette_state__InteractiveState extends State {
      ...
      addComponent<T extends animation.StateMachineComponent>(
        constructor: _cocos_core_animation_marionette_state__StateMachineComponentConstructor<T>
      ): T
    ...
    export type _cocos_core_animation_marionette_animation_graph__TransitionInternal =
      _cocos_core_animation_marionette_animation_graph__Transition
    export const _cocos_core_animation_marionette_state__incomingsSymbol: unique symbol
    export interface _cocos_core_animation_marionette_animation_graph__BasicVariableDescription<
      TType
    > {
      readonly type: TType
    ...
    export class _cocos_core_animation_marionette_animation_graph__TriggerVariable
      implements
        _cocos_core_animation_marionette_animation_graph__BasicVariableDescription<animation.VariableType.TRIGGER>
    {
      get type(): animation.VariableType.TRIGGER
      get value(): boolean
      set value(value: boolean)
      get resetMode(): _cocos_core_animation_marionette_animation_graph__TriggerResetMode
      set resetMode(value: _cocos_core_animation_marionette_animation_graph__TriggerResetMode)
    }
    ...
    export class _cocos_core_animation_marionette_condition__BinaryConditionEval
      implements _cocos_core_animation_marionette_condition__ConditionEval
    {
      constructor(
        operator: _cocos_core_animation_marionette_condition__BinaryOperator,
        lhs: number,
        rhs: number
      )
    ...
    export type _cocos_core_animation_marionette_condition__ConditionEvalContext =
      _cocos_core_animation_marionette_parametric__BindContext
    export class _cocos_core_animation_marionette_condition__UnaryConditionEval
      implements _cocos_core_animation_marionette_condition__ConditionEval
    {
      constructor(
        operator: _cocos_core_animation_marionette_condition__UnaryOperator,
        operand: boolean
      )
    ...
    export interface _cocos_core_animation_marionette_motion__Motion {
      [_cocos_core_animation_marionette_create_eval__createEval](
        context: _cocos_core_animation_marionette_motion__MotionEvalContext
      ): _cocos_core_animation_marionette_motion__MotionEval | null
      clone(): _cocos_core_animation_marionette_motion__Motion
    }
    export class _cocos_core_animation_marionette_clip_motion__ClipMotionEval
      implements _cocos_core_animation_marionette_motion__MotionEval
    {
      /**
       * @legacyPublic
       */
    ...
    export class _cocos_core_animation_marionette_animation_blend__AnimationBlendItem {
      ...
      protected _assign(
        that: _cocos_core_animation_marionette_animation_blend__AnimationBlendItem
      ): _cocos_core_animation_marionette_animation_blend__AnimationBlendItem
    }
    export class _cocos_core_animation_marionette_animation_blend_direct__AnimationBlendDirectItem extends _cocos_core_animation_marionette_animation_blend__AnimationBlendItem {
      ...
      protected _assign(
        that: _cocos_core_animation_marionette_animation_blend_direct__AnimationBlendDirectItem
      ): _cocos_core_animation_marionette_animation_blend_direct__AnimationBlendDirectItem
    }
    export class _cocos_core_animation_marionette_animation_blend_1d__AnimationBlend1DItem extends _cocos_core_animation_marionette_animation_blend__AnimationBlendItem {
      ...
      protected _assign(
        that: _cocos_core_animation_marionette_animation_blend_1d__AnimationBlend1DItem
      ): _cocos_core_animation_marionette_animation_blend_1d__AnimationBlend1DItem
    }
    ...
    export class _cocos_core_animation_marionette_animation_blend_2d__AnimationBlend2DItem extends _cocos_core_animation_marionette_animation_blend__AnimationBlendItem {
      ...
      protected _assign(
        that: _cocos_core_animation_marionette_animation_blend_2d__AnimationBlend2DItem
      ): _cocos_core_animation_marionette_animation_blend_2d__AnimationBlend2DItem
    }
    ...
    export type _cocos_core_animation_marionette_animation_mask__JointMaskInfo_ =
      _cocos_core_animation_marionette_animation_mask__JointMaskInfo
  }
