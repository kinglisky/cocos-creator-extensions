  ...
  export module Editor {
    ...
    export module Message {
      ...
      export function request<
        J extends string,
        K extends keyof EditorMessageMaps[J]
      >(
        name: J,
        message: K,
      ...
      export function send<
        M extends string,
        N extends keyof EditorMessageMaps[M]
      >(name: M, message: N, ...args: EditorMessageMaps[M][N]['params']): void;
      /**
       * 广播一个消息
       * Broadcast a message
       *
    ...
    export module Panel {
      ...
      >(options: Options<Selector, M, U>): any;
    }
    ...
    export module Task {
       ...
       * @param message 任务内容 Content of the task
       */
      export function updateSyncTask(
        title: string,
        describe?: string,
        message?: string
      ): any;
